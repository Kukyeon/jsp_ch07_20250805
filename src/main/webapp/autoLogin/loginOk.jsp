...
<body>
	<%
		...
		//System.out.println(rememberid); // 체크시 on, 체크해제시 null
		...
		if(mid.equals("tiger") && mpw.equals("12345")){
			...
			response.sendRedirect("welcome.jsp"); // 로그인 성공시 웰컴페이지로 강제이동
		} else {
			response.sendRedirect("login.jsp"); // 로그인 실패시 로그인 페이지로 다시이동
		}
	%>
</body>
</html>